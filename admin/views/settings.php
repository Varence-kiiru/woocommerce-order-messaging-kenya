...
<div class="wrap">
	<h1><?php _e( 'WhatsApp WooCommerce Settings', 'whatsapp-woocommerce' ); ?></h1>
	...
	<form method="post" action="options.php">
		...
		<div class="wwcc-settings-container">
			...
			<div class="wwcc-tab-content">
				<h2><?php _e( 'WhatsApp Configuration', 'whatsapp-woocommerce' ); ?></h2>

				<table class="form-table">
					<tr>
						<th scope="row">
							<label for="whatsapp_provider"><?php _e( 'WhatsApp Provider', 'whatsapp-woocommerce' ); ?></label>
						</th>
						<td>
							<select name="wwcc_settings[whatsapp_provider]" id="whatsapp_provider" onchange="toggleWhatsAppProvider()">
								<option value="twilio" <?php selected( $settings['whatsapp_provider'] ?? '', 'twilio' ); ?>>
									<?php _e( 'Twilio', 'whatsapp-woocommerce' ); ?>
								</option>
								<option value="meta" <?php selected( $settings['whatsapp_provider'] ?? '', 'meta' ); ?>>
									<?php _e( 'Meta (WhatsApp Business)', 'whatsapp-woocommerce' ); ?>
								</option>
							</select>
							<p class="description">
								<?php _e( 'Choose WhatsApp API provider. Twilio is easier to set up, Meta is more scalable.', 'whatsapp-woocommerce' ); ?>
							</p>
						</td>
					</tr>
					...
					<tr>
						<th scope="row">
							<label for="business_phone"><?php _e( 'Business WhatsApp Number', 'whatsapp-woocommerce' ); ?></label>
						</th>
						<td>
							...
							<p class="description">
								<?php _e( 'Your business WhatsApp number with country code (e.g., +2547XXXXXXXX)', 'whatsapp-woocommerce' ); ?>
							</p>
						</td>
					</tr>
				</table>
				...
				<div id="twilio-settings" class="provider-settings">
					<h3><?php _e( 'Twilio Configuration', 'whatsapp-woocommerce' ); ?></h3>
					<table class="form-table">
						<tr>
							<th scope="row">
								<label for="twilio_sid"><?php _e( 'Twilio Account SID', 'whatsapp-woocommerce' ); ?></label>
							</th>
							<td>
								<input type="password" name="wwcc_settings[twilio_sid]" id="twilio_sid" 
									value="<?php echo esc_attr( $settings['twilio_sid'] ?? '' ); ?>" />
								<p class="description">
									<?php _e( 'Get from Twilio Console', 'whatsapp-woocommerce' ); ?>
								</p>
							</td>
						</tr>
						...
						<tr>
							<th scope="row">
								<label for="twilio_token"><?php _e( 'Twilio Auth Token', 'whatsapp-woocommerce' ); ?></label>
							</th>
							<td>
						...
						<tr>
							<th scope="row">
								<label for="twilio_phone"><?php _e( 'Twilio WhatsApp Number', 'whatsapp-woocommerce' ); ?></label>
							</th>
							<td>
								...
								<p class="description">
									<?php _e( 'Your Twilio WhatsApp sandbox number', 'whatsapp-woocommerce' ); ?>
								</p>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
								<button type="button" class="button button-secondary" onclick="testWhatsAppConnection()">
									<?php _e( 'Test Connection', 'whatsapp-woocommerce' ); ?>
								</button>
							</td>
						</tr>
					</table>
				...
				<div id="meta-settings" class="provider-settings" style="display:none;">
					<h3><?php _e( 'Meta (WhatsApp Business) Configuration', 'whatsapp-woocommerce' ); ?></h3>
					<table class="form-table">
						<tr>
							<th scope="row">
								<label for="meta_phone_number_id"><?php _e( 'Phone Number ID', 'whatsapp-woocommerce' ); ?></label>
							</th>
							<td>
								...
								<p class="description">
									<?php _e( 'From Meta Business Manager', 'whatsapp-woocommerce' ); ?>
								</p>
							</td>
						</tr>
						...
						<tr>
							<th scope="row">
								<label for="meta_access_token"><?php _e( 'Access Token', 'whatsapp-woocommerce' ); ?></label>
							</th>
							<td>
			...
			<div class="wwcc-tab-content">
				<h2><?php _e( 'M-Pesa Configuration (Daraja)', 'whatsapp-woocommerce' ); ?></h2>

				<table class="form-table">
					<tr>
						<th scope="row">
							<label for="daraja_consumer_key"><?php _e( 'Consumer Key', 'whatsapp-woocommerce' ); ?></label>
						</th>
						<td>
							...
							<p class="description">
								<?php _e( 'Get from Safaricom Daraja', 'whatsapp-woocommerce' ); ?>
							</p>
						</td>
					</tr>
					...
					<tr>
						<th scope="row">
							<label for="daraja_consumer_secret"><?php _e( 'Consumer Secret', 'whatsapp-woocommerce' ); ?></label>
						</th>
						<td>
					...
					<tr>
						<th scope="row">
							<label for="mpesa_till_number"><?php _e( 'Till Number (Shortcode)', 'whatsapp-woocommerce' ); ?></label>
						</th>
						<td>
							<input type="text" name="wwcc_settings[mpesa_till_number]" id="mpesa_till_number" 
								...
								placeholder="600XXX" />
							<p class="description">
								<?php _e( 'Your M-Pesa business till number', 'whatsapp-woocommerce' ); ?>
							</p>
						</td>
					</tr>
					...
					<tr>
						<th scope="row">
							<label for="mpesa_passkey"><?php _e( 'Online Passkey', 'whatsapp-woocommerce' ); ?></label>
						</th>
						<td>
							<input type="password" name="wwcc_settings[mpesa_passkey]" id="mpesa_passkey" 
								value="<?php echo esc_attr( $settings['mpesa_passkey'] ?? '' ); ?>" />
							<p class="description">
								<?php _e( 'M-Pesa Online Passkey (obtained from Safaricom)', 'whatsapp-woocommerce' ); ?>
							</p>
						</td>
					</tr>
			...
			<!-- Feature Settings -->
			<div class="wwcc-tab-content">
				<h2><?php _e( 'Feature Settings', 'whatsapp-woocommerce' ); ?></h2>

				<table class="form-table">
					<tr>
						<th scope="row">
							<label for="enable_notifications"><?php _e( 'Enable Order Notifications', 'whatsapp-woocommerce' ); ?></label>
						</th>
						<td>
							...
							<p class="description">
								<?php _e( 'Send WhatsApp notifications for new orders, payments, and shipping updates', 'whatsapp-woocommerce' ); ?>
							</p>
						</td>
					</tr>
					...
					<tr>
						<th scope="row">
							<label for="enable_order_creation"><?php _e( 'Enable Order Creation from WhatsApp', 'whatsapp-woocommerce' ); ?></label>
						</th>
						<td>
							...
							<p class="description">
								<?php _e( 'Allow customers to create orders by messaging WhatsApp', 'whatsapp-woocommerce' ); ?>
							</p>
						</td>
					</tr>
					...
					<tr>
						<th scope="row">
							<label for="enable_cart_recovery"><?php _e( 'Enable Cart Recovery', 'whatsapp-woocommerce' ); ?></label>
						</th>
						<td>
							...
							<p class="description">
								<?php _e( 'Send WhatsApp reminders for abandoned carts', 'whatsapp-woocommerce' ); ?>
							</p>
						</td>
					</tr>
					...
					<tr>
						<th scope="row">
							<label for="cart_recovery_hours"><?php _e( 'Cart Recovery After (Hours)', 'whatsapp-woocommerce' ); ?></label>
						</th>
						<td>
							<input type="number" name="wwcc_settings[cart_recovery_hours]" id="cart_recovery_hours" 
								...
								min="0" max="72" />
							<p class="description">
								<?php _e( 'Hours to wait before sending cart recovery message', 'whatsapp-woocommerce' ); ?>
							</p>
						</td>
					</tr>
					...
					<tr>
						<th scope="row">
							<label for="enable_mpesa_stk"><?php _e( 'Enable M-Pesa STK Push', 'whatsapp-woocommerce' ); ?></label>
						</th>
						<td>
							...
							<p class="description">
								<?php _e( 'Send payment prompts to customer phones automatically', 'whatsapp-woocommerce' ); ?>
							</p>
						</td>
					</tr>
					...
					<tr>
						<th scope="row">
							<label for="enable_debug"><?php _e( 'Enable Debug Mode', 'whatsapp-woocommerce' ); ?></label>
						</th>
						<td>
							<input type="checkbox" name="wwcc_settings[enable_debug]" id="enable_debug" 
								value="1" <?php checked( $settings['enable_debug'] ?? 0 ); ?> />
							<p class="description">
								<?php _e( 'Log debug information (disable in production)', 'whatsapp-woocommerce' ); ?>
							</p>
						</td>
					</tr>
				</table>
...
function testMPesaConnection() {
	if (confirm('<?php _e( 'Test M-Pesa connection?', 'whatsapp-woocommerce' ); ?>')) {
		jQuery.ajax({
...
function testWhatsAppConnection() {
	const phone = prompt('<?php _e( 'Enter your phone number (with country code):', 'whatsapp-woocommerce' ); ?>');
	if (!phone) return;
